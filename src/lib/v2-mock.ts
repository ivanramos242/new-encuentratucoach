...
export const qaTopics: QaTopic[] = [
  {
    slug: "elegir-coach",
    name: "Elegir coach",
    description: "Dudas sobre cómo elegir un coach adecuado para tu objetivo.",
    curated: true,
  },
  {
    slug: "precios",
...
export const qaQuestions: QaQuestion[] = [
  {
    ...
    title: "Cómo elegir un coach de carrera si estoy bloqueado con varias opciones",
    body: "Quiero cambiar de trabajo pero no tengo claro si necesito coaching de carrera o un coach de liderazgo. Trabajo en tecnología y me bloquea tomar decisiones. ¿Cómo elegir bien?",
    ...
    answers: [
      ...
      makeAnswer({
        ...
        body: "Puedes hacer una llamada breve con dos perfiles y comparar su método. Mira claridad en proceso, no solo experiencia.",
        votesCount: 3,
        voteScore: 2,
  ...
  },
  {
    ...
    title: "Cuál es un precio normal para coaching personal online en España",
    body: "Estoy viendo precios muy distintos para coaching personal online. ¿Qué rango es razonable para empezar sin pagar de más?",
    ...
    answers: [
      makeAnswer({
        ...
        body: "Para coaching personal online es habitual ver desde 60 EUR a 120 EUR por sesión, según experiencia y formato. Valora también si incluye seguimiento.",
        votesCount: 8,
        voteScore: 8,
  ...
  },
  {
    ...
    body: "Tengo dudas sobre si una sesión online puede ser igual de útil que una presencial para trabajar hábitos y claridad.",
  ...
  },
  {
    ...
    title: "Qué certificación de coach es más relevante al comparar perfiles",
    body: "Estoy comparando coaches y veo siglas distintas. ¿Qué certificaciones conviene mirar y qué peso les doy frente a reseñas o experiencia?",
    authorUserId: "user-client-4",
    authorDisplayName: "Anónimo",
    isAnonymous: true,
    status: "published",
    topicSlug: "certificacion",
    topicName: "Certificación",
    ...
    answers: [
      makeAnswer({
        ...
        questionId: "q-4",
        coachProfileId: coaches[0]?.id ?? coaches[0].id,
        body: "Mira certificación, especialidad y resultados/experiencia. La certificación suma confianza, pero el encaje con tu objetivo y el método importa mucho.",
        votesCount: 5,
        voteScore: 4,
    ...
    messages: [
      {
        ...
        body: "Hola Cristina. Estoy valorando un cambio de trabajo y me gustaría saber cómo trabajas objetivos de carrera.",
        createdAt: isoMinutesAgo(180),
      ...
      },
      {
        ...
        body: "Hola Carlos. Podemos empezar con una sesión de diagnóstico para definir objetivo, contexto y siguientes pasos.",
      ...
      },
      {
        ...
        senderUserId: "user-client-1",
        senderLabel: "Carlos Martinez",
        body: "Perfecto. Te envío un resumen de mi situación en PDF.",
    ...
    messages: [
      {
        ...
        body: "Puedo ayudarte con hábitos y seguimiento semanal. Si te encaja, empezamos con una sesión inicial.",
...
export const notificationRecords: NotificationRecord[] = [
  {
    ...
    body: "Carlos Martinez te ha enviado un mensaje en la conversación con Cristina Torres dos Santos.",
    isRead: false,
    createdAt: isoMinutesAgo(6),
  ...
  },
  {
    ...
    body: "Una respuesta ha sido marcada como aceptada en una pregunta que seguías.",
    isRead: true,
    createdAt: isoMinutesAgo(180),
    data: { questionId: "q-1" },
  },
