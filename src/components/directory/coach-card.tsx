      ...
      <div className="p-5">
        ...
        <div className="mt-4 flex items-center gap-2">
          ...
          <Link
            ...
            className="inline-flex flex-1 items-center justify-center rounded-xl bg-zinc-950 px-4 py-2.5 text-sm font-semibold !text-white hover:bg-zinc-800 hover:!text-white"
          >
            Ver perfil
          </Link>
        </div>
